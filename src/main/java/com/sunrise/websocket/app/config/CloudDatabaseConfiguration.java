package com.sunrise.websocket.app.config;
...
@Configuration
@EnableMongoRepositories("com.sunrise.websocket.app.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.sunrise.websocket.app.config.dbmigrations");
